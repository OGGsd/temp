      ...
      items: [
        {
          ...
          label: "About AxieStudio"
        },
        {
          type: "doc",
          id: "Get-Started/get-started-installation",
          label: "Install AxieStudio"
        },
        {
          type: "doc",
          ...
          items: [
            {
              ...
              label: "Trigger flows with the AxieStudio API"
            },
            {
              type: "doc",
              id: "Develop/webhook",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: "Use AxieStudio data types"
        },
        {
          type: "doc",
      ...
      items: [
        {
          ...
          label: "AxieStudio deployment overview"
        },
        {
          type: "doc",
          id: "Deployment/deployment-public-server",
          label: "Deploy a public AxieStudio server"
        },
        {
          type: "category",
          ...
          items: [
            "Develop/develop-application",
            {
              ...
              label: "AxieStudio Docker images"
            },
            {
              type: "doc",
              id: "Deployment/deployment-caddyfile",
              label: "Deploy AxieStudio on a remote server"
            },
            {
              type: "category",
              label: "Kubernetes",
      ...
      items: [
        {
          ...
          label: "Get started with the AxieStudio API",
        },
        {
          type: "doc",
        ...
        {
          type: "link",
          label: "AxieStudio API specification",
          href: "/api",
        },
      ],
    },
