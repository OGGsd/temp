...
Follow these best practices when submitting a template to AxieStudio.

For template formatting examples, see [`/starter_projects`](https://github.com/AxieStudio-ai/AxieStudio/tree/main/src/backend/base/AxieStudio/initial_setup/starter_projects) in the AxieStudio repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [AxieStudio repository](https://github.com/AxieStudio-ai/AxieStudio) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main AxieStudio repository.
5. Include a screenshot of your template in the PR.

The AxieStudio team will review your PR, offer feedback, and, if approved, merge the template.
...
For more information, see the AxieStudio repository's [template categories](https://github.com/AxieStudio-ai/AxieStudio/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).