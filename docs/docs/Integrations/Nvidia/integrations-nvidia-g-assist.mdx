---
title: Integrate NVIDIA G-Assist with AxieStudio
slug: /integrations-nvidia-g-assist
---

:::important
The **NVIDIA G-Assist** component is available only for AxieStudio users with NVIDIA GPUs on Windows systems.
:::
...
* NVIDIA GPU
* `gassist.rise` package installed. This package is included in your [AxieStudio installation](/get-started-installation).
