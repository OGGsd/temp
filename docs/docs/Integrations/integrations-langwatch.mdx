...
To integrate with AxieStudio, add your LangWatch API key as a AxieStudio environment variable:

1. Get a LangWatch API key from your LangWatch account.

2. Add the key to your AxieStudio `.env` file:
...
3. Restart AxieStudio with your `.env` file, if you modified the AxieStudio `.env`:
