...
Bundles contain custom components that support specific third-party integrations with axiestudio.
You add them to your flows and configure them in the same way as AxieStudio's core components.

## Bundle maintenance and documentation

Many bundled components are developed by third-party contributors to the AxieStudio codebase.
...
To find documentation for a specific bundled component, browse the AxieStudio docs and your provider's documentation.
...
the AxieStudio documentation focuses on using bundles within flows.
For that reason, it focuses on the AxieStudio-specific configuration steps for bundled components.
...
:::tip
the AxieStudio documentation doesn't list all bundles or components in bundles.
For the most accurate and up-to-date list of bundles and components for your version of AxieStudio, check the **Components** menu in axiestudio.

If you can't find a component that you used in an earlier version of AxieStudio, it may have been removed or marked as a [legacy component](#legacy-components).
:::

AxieStudio offers core components in addition to third-party, provider-specific bundles.
...
<!-- Not documented but in AxieStudio as of 1.5.11 -->
<!--
* AgentQL
* Confluence
* Firecrawl
