...
**Language Model** components in AxieStudio generate text using a specified Large Language Model (LLM).

AxieStudio includes a **Language Model** core component that has built-in support for many LLMs.
