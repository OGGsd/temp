...
AxieStudio's **Logic** components provide functionalities for routing, conditional processing, and flow management.
...
:::tip
For more examples of the **Loop** component, try the **Research Translation Loop** template in AxieStudio, or see the video tutorial [Mastering the Loop Component & Agentic RAG in AxieStudio](https://www.youtube.com/watch?v=9Wx7WODSKTo).
:::
...
The **Run Flow** component runs another AxieStudio flow as a subprocess of the current flow.
...
It was deprecated in AxieStudio version 1.1.2 and replaced by the [**Run Flow** component](#run-flow).
