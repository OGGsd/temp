...
from axiestudio.services.tracing.base import BaseTracer
...
if TYPE_CHECKING:
    ...
    from axiestudio.services.tracing.schema import Log
...
class LangFuseTracer(BaseTracer):
    ...
    def add_trace(
        ...
        metadata_: dict = {"from_axiestudio_component": True, "component_id": trace_id}
