...
from axiestudio.api.v2 import files_router as files_router_v2
from axiestudio.api.v2 import mcp_router as mcp_router_v2
...
router_v1.include_router(local_llms_router)
